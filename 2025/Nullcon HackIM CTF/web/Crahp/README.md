# Crahp [50 points] (272 solves)
Generated code to brute force:
```php
<?php
...
// Function to generate random strings of length 16
...
while (!$found) {
    ...
    if ($password == $MYPASSWORD) continue;

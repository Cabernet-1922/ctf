# la cifra de [Medium] (by Alex Fulton/Daniel Tunitis) - picoCTF 2019
> I found this cipher in an old book. Can you figure out what it says? Connect with <code>nc jupiter.challenges.picoctf.org 58295</code>.

With [online tool](https://www.guballa.de/vigenere-solver) to decrypt the cipher:
```text
